...
TEST(engine_change_preserves_dynamic_status_icon_for_tray) {
    ...
    typio_daemon_test_on_engine_change(instance, &mock_rime_info, &app);
...
TEST(engine_change_uses_static_icon_after_dynamic_engine) {
    ...
    typio_daemon_test_on_engine_change(instance, NULL, &app);
...
TEST(voice_engine_change_updates_tray_tooltip) {
    ...
    typio_daemon_test_update_tray_engine_status(&app);
    ...
    typio_daemon_test_on_voice_engine_change(instance, &mock_voice_info, &app);
...
void typio_status_bus_set_runtime_state_callback([[maybe_unused]] TypioStatusBus *bus,
                                                 [[maybe_unused]] TypioStatusBusRuntimeStateCallback callback,
