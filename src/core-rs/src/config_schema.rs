...
lazy_static::lazy_static! {
    ...
    SchemaEntry { key: "display.popup_mode_indicator", type_: TypioFieldType::TypioFieldBool, def: SchemaDefault::Bool(true), ui_label: Some("Mode indicator"), ui_section: Some("display"), ui_min: 0, ui_max: 0, ui_step: 0, ui_options: None, runtime_property: None },
