 ...
 *
 * ADR-0011. The engine emits the whole in-flight composition in one
...
/* Composition (preedit + candidates) — set atomically, ADR-0011.
...
/* Read projections of the stored composition */
