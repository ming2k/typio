...
#include "candidate_panel_layout.h"
#include "candidate_panel_paint.h"
#include "candidate_panel_theme.h"
...
extern "C" TypioWlCandidatePanel *typio_wl_candidate_panel_create(TypioWlFrontend *frontend) {
...
extern "C" void typio_wl_candidate_panel_destroy(TypioWlCandidatePanel *popup) {
    if (!popup) return;
    hide_surface(popup);
    fx_teardown(popup);
...
extern "C" bool typio_wl_candidate_panel_update_content(TypioWlTextUiBackend *backend,
...
extern "C" bool typio_wl_candidate_panel_update(TypioWlTextUiBackend *backend, TypioInputContext *ctx) {
...
extern "C" void typio_wl_candidate_panel_hide(TypioWlTextUiBackend *backend) {
    if (backend && backend->candidate_panel) hide_surface(backend->candidate_panel);
}

extern "C" bool typio_wl_candidate_panel_is_available(TypioWlTextUiBackend *backend) {
    return backend && backend->candidate_panel && backend->candidate_panel->surface && backend->candidate_panel->popup_surface;
}

extern "C" bool typio_wl_candidate_panel_present_retry_pending(TypioWlTextUiBackend *backend) {
    return backend && backend->candidate_panel && backend->candidate_panel->present_retry;
}

extern "C" void typio_wl_candidate_panel_invalidate_config(TypioWlTextUiBackend *backend) {
...
extern "C" void typio_wl_candidate_panel_handle_output_change(TypioWlTextUiBackend *backend, struct wl_output *output) {
...
extern "C" bool typio_wl_candidate_panel_show_status(TypioWlTextUiBackend *backend,
                                                      const char *text) {
    if (!backend || !backend->frontend) return false;
